...
{schoolStore.selectedSchool.name ? (
            <React.Fragment>
              ...
              <CurrencyFormat value={schoolStore.selectedSchool['net_price']} displayType={'text'} thousandSeparator={true} prefix={'$'} renderText={value => <h2 className="display-4">{value} / year</h2>} /> 
              ...
              <div onClick={() => this.schoolStore.goToResults(major)} key={major.id} className='col-md-4'>
                <div className='card shadow-lg mb-3 quote-card '>
                  <div className='card-body text-dark'>
                    ...
                    <CurrencyFormat value={major['mid_careeer_medium_salary']} displayType={'text'} thousandSeparator={true} prefix={'$'} renderText={value => <p>Median Salary: {value}</p> } /> 
